<?php
	...
	switch ($method) {
		case 'GET':
			$searchMaterial = convert_numbers(split(" ", strtolower(str_replace("  ", " ", str_replace("  ", " ", str_replace(";", " ", str_replace(".", " ", str_replace("\\", " ", str_replace("+", " plus ", str_replace("!", "", str_replace("?", "", str_replace("&", " and ", str_replace("-", " ", str_replace(",", "", str_replace(", ", " ", str_replace('"', '', str_replace("'", "", $request[0])))))))))))))))));
	...
	function searchMatches($title, $subtitle, $material, $distance, $percent, $stopwords, $rep, $ins, $del, &$matches, &$notmatches) {
		$titlearray = convert_numbers(split(" ", strtolower(str_replace("  ", " ", str_replace("  ", " ", str_replace(";", " ", str_replace(":", " ", str_replace(".", " ", str_replace("/", " ", str_replace("+", " plus ", str_replace("!", "", str_replace("?", "", str_replace("&", " and ", str_replace("-", " ", str_replace(",", "", str_replace(", ", " ", str_replace('"', '', str_replace("'", "", $title))))))))))))))))));
		$subtitlearray = convert_numbers(split(" ", strtolower(str_replace("  ", " ", str_replace("  ", " ", str_replace(";", " ", str_replace(":", " ", str_replace(".", " ", str_replace("/", " ", str_replace("+", " plus ", str_replace("!", "", str_replace("?", "", str_replace("&", " and ", str_replace("-", " ", str_replace(",", "", str_replace(", ", " ", str_replace('"', '', str_replace("'", "", $subtitle))))))))))))))))));
		$found = [];
